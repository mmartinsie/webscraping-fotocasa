...
- The tool's parameters (`distrito`, `habitaciones`, `aseos`, `superficie`,
  `parking`, `colegios`) are fixed here. If you retrain the network with a
  different feature set, update `estimar_precio` and `SYSTEM`.
